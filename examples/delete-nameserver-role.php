...
// Delete existing nameserver role
$demo->deleteNameserverRole($data['nameserver_id'], $data['nameserver_role_id']);
...
// Nameserver role successfully deleted!
echo 'Nameserver Role "'. $data['nameserver_role_id'] .'" deleted';